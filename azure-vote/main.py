...
app_insights_ctr = "InstrumentationKey=b97ddd30-3d8b-41fc-a58d-461a00b98297"
insight = AzureLogHandler(connection_string=app_insights_ctr)
# Logging
logger = logging.getLogger(__name__)
logger.addHandler(insight)
# Metrics
exporter = metrics_exporter.new_metrics_exporter(enable_standard_metrics=True, connection_string=app_insights_ctr)  # TODO: Setup exporter
